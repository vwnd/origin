/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: e04f7ed2e9ae1cc3845ea17f89e3a974)
// Runtime types generated with workerd@1.20260820.1 2026-06-11 nodejs_compat
interface __BaseEnv_Env {
	INSTRUCTIONS: R2Bucket;
	DB: D1Database;
	SCOUT_ANALYTICS: AnalyticsEngineDataset;
	AI: Ai;
	...
	InspectionAgent: DurableObjectNamespace<import("./src/server").InspectionAgent>;
	EventsAgent: DurableObjectNamespace<import("./src/server").EventsAgent>;
	INSPECTION_WORKFLOW: Workflow<Parameters<import("./src/server").InspectionWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "ChatAgent" | "InspectionAgent" | "EventsAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SPECKLE_TOKEN" | "SPECKLE_WEBHOOK_SECRET" | "ANTHROPIC_API_KEY">> {}
}
